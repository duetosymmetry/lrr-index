...
defaultURL      = ('https://inspirehep.net/api/literature'
                   ...
                   '&fields=authors.full_name,authors.last_name,'
                   'first_author,abstracts,titles,dois,'
                   'publication_info.journal_title,'
                   'publication_info.journal_volume,publication_info.year,'
                   'publication_info.artid,publication_info.page_start,'
                   'arxiv_eprints')
